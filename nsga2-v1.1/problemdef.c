...
#ifdef zdt1
void test_zdt1 (double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
    double f1, f2, g, h;
    int i;
    f1 = xreal[0];
...
#ifdef zdt2
void test_zdt2 (double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
    double f1, f2, g, h;
    int i;
    f1 = xreal[0];
...
#ifdef zdt3
void test_zdt3 (double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
    double f1, f2, g, h;
    int i;
    f1 = xreal[0];
...
#ifdef zdt4
void test_zdt4 (double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
    double f1, f2, g, h;
    int i;
    f1 = xreal[0];
...
#ifdef zdt6
void test_zdt6 (double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
    double f1, f2, g, h;
    int i;
...
/*DTLZ*/
#ifdef dtlz1
void test_dtlz1(double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
	int j;
	double sum;
	double g;
	...
	for (j = m - 1; j < n; j++)
	{
		sum += pow(xreal[j] - 0.5, 2.0) - cos(20.0 * PI * (xreal[j] - 0.5));
	}
	g = 100.0 * (k + sum);
...
#ifdef dtlz2
/* DTLZ2 - MOP */
void test_dtlz2(double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
	int j;
	double sum;
	double g;
	...
	obj[0] = (1.0 + g) * cos(xreal[0] * PI * 0.5) * cos(xreal[1] * PI * 0.5);
	obj[1] = (1.0 + g) * cos(xreal[0] * PI * 0.5) * sin(xreal[1] * PI * 0.5);
	obj[2] = (1.0 + g) * sin(xreal[0] * PI * 0.5);
	return;
}
#endif
#ifdef dtlz3
/* DTLZ3 - MOP */
void test_dtlz3(double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
	int j;
	double sum;
	double g;
...
void test_dtlz4(double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
	int j;
	double alpha;
	...
	obj[0] = (1.0 + g) * cos(factor1 * PI * 0.5) * cos(factor2 * PI * 0.5);
	obj[1] = (1.0 + g) * cos(factor1 * PI * 0.5) * sin(factor2 * PI * 0.5);
	obj[2] = (1.0 + g) * sin(factor1 * PI * 0.5);
	return;
}
#endif
/* DTLZ5 - MOP */
#ifdef dtlz5
void test_dtlz5(double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
	int j;
	double g;
	double tetha[3];
	...
	tetha[0] = (PI * 0.5) * xreal[0];
	tetha[1] = (PI / (4.0 * (1.0 + g))) * (1.0 + 2.0 * g * xreal[1]);
...
void test_dtlz6(double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
	int j;
	double g;
	double tetha[3];
...
/* DTLZ7 - MOP */
#ifdef dtlz7
void test_dtlz7(double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
	int j;
	double sum;
	double g, h;
	...
	obj[0] = xreal[0];
	obj[1] = xreal[1];
	h = m - (((obj[0] / (1.0 + g)) * (1.0 + sin(3.0 * PI * obj[0]))) + ((obj[1]/(1.0 + g)) * (1.0 + sin(3.0 * PI * obj[1]))));
	obj[2] = (1.0 + g) * h;
	return;
}
